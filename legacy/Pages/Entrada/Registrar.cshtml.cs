...
namespace FinanzasVineyard.Pages.Entrada
{
    public class RegistrarModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(int? id)
        {
            ...
            return RedirectToPage("./Registrar", new { id = (int)id });
        }
        ...
        {
            IList<ListadoDeConceptos> listadoDeCoceptos = new List<ListadoDeConceptos>();
            bool found = false;
            ...
            foreach (var registro in registros)
            {
                foreach (var otro in registro.Otros)
                {
                    ...
                    foreach (var concepto in listadoDeCoceptos)
                    {
                    ...
                    if (!found)
                    {
                        ...
                        listadoDeCoceptos.Add(nuevoConcepto);
                    }
                }
            }

            listadoDeCoceptos = listadoDeCoceptos.OrderBy(c => c.Concepto).ToList();

            return listadoDeCoceptos;
        }
    ...
    public class ListadoDeConceptos
    {
        public string? Concepto { get; set; }
        public double ImporteMxn { get; set; }
